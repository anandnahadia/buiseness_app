...
We examine annual percentage rates, annual fees. 
        ...
        <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
            ...
            <div className='absolute z-[1] bottom-40 w-[80%] h-[80%] rounded-full white__gradient'></div>
            <div className='absolute z-[0] top-0 w-[50%] h-[50%] right-20 bottom-20 blue__gradient'></div>
        </div>
